 ...
 *        Derived from Prof Chek's BST class with changes
 * @date 6 Nov 2023
 */
#ifndef BST_H
#define BST_H
...
class BST {
  ...
  protected:
     ...
     * protected so that it can be used by derived classes (e.g., AVL)
     ...
     */    
    void findSuccessor(BinTree tree, BinTree& successor) const;
    /**
     * @brief Check if the tree is empty
...
// necessary for templated classes.
